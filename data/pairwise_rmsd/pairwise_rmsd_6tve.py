...
for stepsize in [1000, 200, 100, 50, 10]:
    print(stepsize)
    matrix_6tve_bindingsite = diffusionmap.DistanceMatrix(allosteric_bindingsite_trajectories['6tve'].residue_atoms)
    matrix_6tve_bindingsite.run(start=1, stop=50000, step=stepsize)
    np.save(f"matrix_6tve_bindingsite_{stepsize}", matrix_6tve_bindingsite.results.dist_matrix)
